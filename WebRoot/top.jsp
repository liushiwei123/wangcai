  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
		您好：<span class="username">${user.userName}</span>，欢迎使用旺财财务管理系统！ <a href="user?op=userLogout" target="_top">退出</a>     		
      </td>
      </tr>
      <tr>
		...
		<dd><div class='itemsel' id='item1' onMouseMove="mv(this,'move',1);" onMouseOut="mv(this,'o',1);"><a href="menu.asp" onclick="changeSel(1)" target="main">主菜单</a></div></dd>
		...
		<dd><div class='item' id='item8' onMouseMove="mv(this,'m',8);" onMouseOut="mv(this,'o',8);"><a href="menu.html" onclick="changeSel(8)" target="main">插件模块</a></div></dd>
